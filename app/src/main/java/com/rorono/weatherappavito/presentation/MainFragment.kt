...
class MainFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.imSearch.setOnClickListener {
            val result = binding.etSearchCityName.text.toString()
            ...
            when(state){
                ...
                is WeatherState.Loading->{
                    with(binding){
                        ...
                        imSearch.visibility =View.INVISIBLE
                        etSearchCityName.visibility = View.INVISIBLE
                        tvData.visibility = View.INVISIBLE
                    }
                }
                is WeatherState.Success ->{
                    Log.d("TEST90","success")
                    ...
                    with(binding){
                        ...
                        imSearch.visibility =View.VISIBLE
                ...
                is WeatherState.Error->{
                    ...
                    with(binding){
                        ...
                        imSearch.visibility =View.INVISIBLE
                        etSearchCityName.visibility = View.INVISIBLE
                        tvCondition.text = "Не удалось получить температуру по указанному городу. Пожалуйста проверьте правильность вводимых данных "
                    }
                }
            }
        }
    ...
    private fun checkLocation(){
        if (isLocationEnabled()){
            ...
            DialogManager.getLocationDialog(requireContext(),object :DialogManager.GetLocationDialogListener{
    ...
    private fun getLocation() {
        if (!isLocationEnabled()){
            Toast.makeText(requireContext(),"Местоположение выключено",Toast.LENGTH_LONG).show()//переделать на tv
            return
        }
